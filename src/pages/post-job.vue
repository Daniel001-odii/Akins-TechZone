  ...
  <form @submit.prevent="submitForm">
    ...
    <div v-if="currentIndex === 0" class="form-content">
          ...
          <div class="section">
              ...
              <div class="section-content">
                  <textarea class="job-description" placeholder="Enter your job description here..." v-model="formData.job_tag" required></textarea>
              </div>
              <div class="section-last">
    ...
    <div v-if="currentIndex === 1" class="form-content">
          ...
          <div class="section">
              ...
              <div class="filter-search">
                    ...
                    <input type="search" class="ft-search" placeholder="Search a types of jobs">
              </div>
              <div class="section-last">
                  Examples: Product Designer, Web Designer, Flutter Developer
              </div> -->
            ...
            <div>
                ...
                <div class="tags-container">
                    <div v-for="(tag, index) in tags" :key="index" class="tag">
                      {{ tag }}
                      <span @click="removeTag(index)">&times;</span>
                    </div>
                </div>
                <!-----------sample skills tags-------------->
