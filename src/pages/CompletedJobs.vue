<template>
    <PageTemplate>
        <template #page-tabs>
            ...
            <RouterLink to="completed-jobs"><div class="job-category job-category-active">Completed (15)</div></RouterLink>
            <RouterLink to="declined-jobs"><div class="job-category">Declined (4)</div></RouterLink></template>
        <template #job-cards>
            <PostCard/>
            <PostCard/>
            <PostCard/>
