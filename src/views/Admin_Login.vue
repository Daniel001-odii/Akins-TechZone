      ...
      <div class="form-container">
          <div class="leftSide">
              ...
              <div class="subDiv">
                  ...
                  <h2 style="font-weight: bolder;">Administrator</h2>
      ...
      export default {
          ...
          methods: {
                async login() {
                    this.isLoading = true;
                    try {
                    const response = await axios.post(`${this.api_url}/admin/login`, {
                        email: this.email,
                    ...
                    console.log(token);
                    this.$router.push('/site/administration'); // Redirect to the intended route
                    }
                    catch (error) {
